...
function visInfo(container, ressource, data) {
  ...
  case 'jordstykker':
    ...
    break;  
  case 'postnumre': 
    visData(data, visPostnumre, visPostnummer);
    break;
  case 'sogne':
  case 'politikredse':
  case 'retskredse':
  ...
  case 'opstillingskredse':
    ...
    break;
  case 'storkredse':
    visData(data, visStorkredse, visStorkreds);
    break; 
  case 'valglandsdele':
...
function visVejstykker(data) {
  return function() {
    eo('table',null,null,
      'class', tableclasses);
      visOverskrift('Vejstykker');
      eo('tbody');
        data.forEach(visVejstykkeKort);
      ec('tbody');
    ec('table');
  }
}
...
function visStorkredse(data) {
  return function() {
    eo('table',null,null,
      'class', tableclasses);
      visOverskrift('Storkredse');
      eo('tbody');
        data.forEach(visStorkredsKort);
      ec('tbody');
    ec('table');
  }
}
...
function visValglandsdele(data) {
  return function() {
    eo('table',null,null,
      'class', tableclasses);
      visOverskrift('Valglandsdele');
      eo('tbody');
        data.forEach(visValglandsdelKort);
      ec('tbody');
    ec('table');
  }
}
...
function visPostnumre(data) {
  return function() {
    eo('table',null,null,
      'class', tableclasses);
      visOverskrift('Postnumre');
      eo('tbody');
        data.forEach(visPostnummerKort);
      ec('tbody');
    ec('table');
  }
}
